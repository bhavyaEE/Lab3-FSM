...
VL_ATTR_COLD void Vdfinal___024root___settle__TOP__0(Vdfinal___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdfinal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdfinal___024root___settle__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vdfinal___024root___eval_initial(Vdfinal___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdfinal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdfinal___024root___eval_initial\n"); );
    // Body
    vlSelf->__Vclklast__TOP__clk = vlSelf->clk;
}

VL_ATTR_COLD void Vdfinal___024root___eval_settle(Vdfinal___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdfinal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdfinal___024root___eval_settle\n"); );
    // Body
    Vdfinal___024root___settle__TOP__0(vlSelf);
}

VL_ATTR_COLD void Vdfinal___024root___final(Vdfinal___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdfinal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdfinal___024root___final\n"); );
}

VL_ATTR_COLD void Vdfinal___024root___ctor_var_reset(Vdfinal___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdfinal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdfinal___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->dfinal__DOT__tick = VL_RAND_RESET_I(1);
    vlSelf->dfinal__DOT__ticks__DOT__count = VL_RAND_RESET_I(16);
    vlSelf->dfinal__DOT__f1__DOT__current_state = 0;
    vlSelf->dfinal__DOT__f1__DOT__next_state = 0;
